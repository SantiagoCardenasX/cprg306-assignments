...
<form
  ...
  className="flex flex-col w-full md:w-1/2 mx-auto bg-slate-600 p-4 md:p-10 rounded-lg shadow-lg"
>
  ...
  <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4 md:gap-0">
    <label htmlFor="category" className="text-lg font-bold text-white md:mr-4">
      Category
    </label>
    <select
      id="category"
